export const NavOptions: {
  ...
  //   ],
  // },
  {link: "#personel", label: "Treinadores"},
  {link: "#achievements", label: "Conquistas"},
...
export const ReviewsOptions = [
    {
      name: "Liliana Bento",
      message:
        "Neste momento, ambos meus filhos praticam karate na AKFAFE. O Gustavo iniciou a sua aprendizagem aos 5 e a Alice aos 4 anos. Escolhi esta escola pelos professores e pela reputação! Nestes 5 anos de aprendizagem, tenho muito a agradecer. A AKFAFE não é só uma Associação, é uma família. Todos somos AKFAFE, somos amigos e somos unidos.",
    },
    {
      name: "",
      message:
