...
const FoundersSonia = () => {
  ...
  return (
    <div className="flex justify-end overflow-hidden pb-10">
      ...
      >
        <div className="m-10">
          <img src={senseiMarinho} width={180} alt="" />
        </div>
        <motion.div
        ...
        >
          ...
          >
            ...
            Martinho, concelho de Fafe, foi o Fundador, Diretor Técnico e sócio
            nº 1 da Associação de Karate de Fafe, que se aproxima agora dos 50
            anos de existência.
          </p>
        </motion.div>
